    ...
    className=' relative w-[25vh] mr-[5%] mb-[5%]' key={i}>
       ...
       <h1 className='text-2xl text-zinc-300 mt-3 font-semibold'>
        {c.name||
          ...
          {c.vote_average &&  <div className='absolute right-[-10%] bottom-[25%] bg-yellow-600 rounded-full text-xl font-semibold   text-white w-[5vh] h-[5vh] flex justify-center items-center'>
